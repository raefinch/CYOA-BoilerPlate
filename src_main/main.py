from backend import Character, Checkpoint, Choice, FileParser, GameSession, StoryNode, StoryTree
from TextParser import text_parser
...
from backend.GameSession import GameSession


def main(story_file_path):
    # Load story from a formatted yaml file
...
if __name__ == "__main__":
    story_path = "TextParser/yaml_files/TestText.yaml"
    main(story_path)
